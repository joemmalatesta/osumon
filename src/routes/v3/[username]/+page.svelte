...
{#if userInfo && plays}
	<main class="w-screen h-screen justify-center items-center flex flex-col gap-5 overflow-hidden">
		...
		<a class="text-sm underline-offset-2 underline hover:underline-offset-4 transition-all" href="/v3">Try another</a>
	</div>
		<section
		...
		>
			<div class="text-sm flex justify-center items-center absolute w-20 h-5 bg-gradient-to-r from-gray-300/40 to-gray-300 rounded-tl-xl rounded-br-xl"><p class="opacity-70">{String(userInfo.global_rank).length} Digit</p></div>
